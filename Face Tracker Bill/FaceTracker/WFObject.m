...
- (BOOL)parseObjFileAtPath:(NSString *)filePath
{
    ...
    NSRegularExpression *lineExp = [[NSRegularExpression alloc] initWithPattern:@"^(v|vn|vt|f)\\s+([\\-\\d\\.\\s\\/]+)$"
    ...
    if(!lineExp){
        ...
        /*
        int numMatches = [lineExp numberOfMatchesInString:objContents options:0 range:NSMakeRange(0, objContents.length)];
        ...
        */
        ...
        [lineExp enumerateMatchesInString:objContents
                               ...
                               usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                                   //NSString *fullString = [objContents substringWithRange:result.range];
                                   ...
                                   if(result.numberOfRanges > 2){
                                       ...
                                       //NSCharacterSet *deliniations = [NSCharacterSet characterSetWithCharactersInString:@"/\n \t"];
